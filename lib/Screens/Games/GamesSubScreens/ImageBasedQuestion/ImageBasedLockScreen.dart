...
class ImageBasedLockScreen extends StatefulWidget {
  const ImageBasedLockScreen({super.key});

  @override
  State<ImageBasedLockScreen> createState() => _ImageBasedLockState();
}

class _ImageBasedLockState extends State<ImageBasedLockScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          title: ConstantStrings.imageBasedLockTitle,
