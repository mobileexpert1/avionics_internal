...
class TriviaDetailScreen extends StatefulWidget {
  ...
  const TriviaDetailScreen({super.key, required this.gameId});

  @override
  State<TriviaDetailScreen> createState() => _TriviaDetailScreenState();
}

class _TriviaDetailScreenState extends State<TriviaDetailScreen> {
  @override
  void initState() {
    super.initState();
