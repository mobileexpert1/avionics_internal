...
class TriviaLockScreen extends StatefulWidget {
  const TriviaLockScreen({super.key});

  @override
  State<TriviaLockScreen> createState() => _TriviaLockScreenState();
}

class _TriviaLockScreenState extends State<TriviaLockScreen> {
  ...
  void initState() {
    ...
    AnalyticsService.instance.logVisibleScreen(
      FirebaseEvents.triviaLockScreen,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          title: ConstantStrings.triviaLockTitle,
