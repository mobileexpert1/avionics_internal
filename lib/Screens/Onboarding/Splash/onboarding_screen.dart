  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ResponsiveLayout(
        mobile: _buildPageView(context),
        tablet: _buildPageView(context, isTablet: true),
        web: _buildPageView(context, isWeb: true),
      ),
    );
  }

  Widget _buildPageView(BuildContext context, {bool isTablet = false, bool isWeb = false}) {
    final Size size = MediaQuery.of(context).size;
    double textFontSize = isWeb ? 18 : isTablet ? 16 : 13;
