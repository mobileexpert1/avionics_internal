...
class GlobeControlsState {
  ...
  final ValueNotifier<bool> isSimulatedNightMode = ValueNotifier<bool>(
    false,
  ); // false = textureSwap, true = simulated
  ...
  final ValueNotifier<Color> simulatedNightColor = ValueNotifier<Color>(
    const Color.fromARGB(255, 25, 38, 64),
  );
  final ValueNotifier<double> simulatedNightIntensity = ValueNotifier<double>(
    0.15,
  );

  // Atmosphere controls
  final ValueNotifier<Color> atmosphereColor = ValueNotifier<Color>(
    const Color.fromARGB(255, 57, 123, 185),
  );
  ...
  final ValueNotifier<Set<String>> visiblePoints = ValueNotifier<Set<String>>(
    {},
  );
